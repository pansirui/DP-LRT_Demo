function [recover] = TR_PnP_Kerry_Test(Y, tau, alpha, beta, gamma, lambda1, lambda2, r, d, rho, iter_g, iter_x)
...
save('kerry_recover.mat','recover','-v7.3');
save('kerry_noise.mat','noise','-v7.3');
